      ...
      <div className="page-container">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            >
              <Zap size={17} style={{ color: "#06d6a0" }} strokeWidth={2.5} />
            </div>
            <div className="flex flex-col leading-none">
              <span
                className="font-display font-bold tracking-tight"
                style={{ fontSize: "1.15rem", letterSpacing: "-0.01em", color: "#f0f4f8" }}
              >
                <span>Sure</span>
                <span style={{ color: "#06d6a0" }}>StrikeTips</span>
              </span>
              <span className="text-[9px] tracking-widest uppercase" style={{ color: "#64748b" }}>
                Premium Picks
              </span>
            </div>
          </Link>
